...
export default function Hero({ onGetStarted, onDemoSignIn }: HeroProps) {
  return (
      ...
      <div className="mx-auto max-w-5xl px-4 text-center sm:px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full bg-amber-50 px-3 py-1 text-[10px] font-semibold text-primary border border-amber-100/50">
            ...
            <span className="uppercase tracking-wider">v2.0 Agentic Agenda Generation</span>
          </div>
          
          <h1 className="mx-auto max-w-3xl text-4xl font-semibold tracking-tight text-secondary sm:text-6xl leading-[1.1]">
            Meetings that actually <span className="text-primary italic font-serif">move</span> teams.
          </h1>
          
          <p className="mx-auto max-w-xl text-base font-medium text-muted/80">
            QikAgenda uses AI to build structured, high-impact meetings in seconds. No more wasted hours.
          </p>

          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row pt-4">
            <button
              onClick={onGetStarted}
              className="flex w-full items-center justify-center gap-2.5 rounded-xl bg-secondary px-8 py-3.5 text-[12px] font-bold text-white shadow-lg transition-all hover:bg-slate-800 hover:-translate-y-0.5 active:scale-95 sm:w-auto"
            >
            ...
            <button
              ...
              className="group flex items-center gap-1.5 px-6 py-3.5 text-[12px] font-semibold text-muted transition-colors hover:text-primary"
            >
