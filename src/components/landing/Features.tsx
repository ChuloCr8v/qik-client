  ...
  return (
    <section className="bg-slate-50/50 py-16">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <div className="mb-12">
          <h2 className="text-3xl md:text-4xl! font-bold! text-secondary">Purposeful features <br className=""></br> for productive teams.</h2>
        ...
        >
          {features.map((feature, i) => (
            <motion.div
              ...
              className={`bg-gradient-to-tl ${feature.cardBg} to-transparent rounded-xl border border-border p-3 py-5 transition-all hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5`}
            >
