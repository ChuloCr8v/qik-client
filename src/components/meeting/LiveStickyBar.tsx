...
export default function LiveStickyBar({
    meeting,
    agenda,
    isOverlayOpen,
    onOpen
                    ...
                    <div className="mx-auto flex w-full max-w-[400px] items-center justify-between rounded-full border border-white/10 bg-secondary/95 p-2 shadow-2xl backdrop-blur-xl pointer-events-auto">
                        <div className="flex items-center gap-3 pl-4">
                            <div className="relative flex flex-col items-center justify-center">
                                <div className="absolute h-2 w-2 animate-ping rounded-full bg-emerald-500" />
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="max-w-[120px] truncate text-xs font-medium text-white/60">
                                    {agenda[meeting.activeItemIndex || 0]
                                        ?.title || "Current Topic"}
                                </span>
                            </div>
                        </div>
                        ...
                        <Button
                            onClick={onOpen}
                            className="flex items-center gap-2 rounded-r-full! bg-primary px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-primary/20 transition-all hover:bg-primary/90 active:scale-95"
                        >
