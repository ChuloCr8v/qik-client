    ...
    return (
        <div className="space-y-3 ">
            <div className="flex items-center gap-2">
                ...
                <h3 className="text-left  font-semibold text-secondary">
                    Generate Agenda
                </h3>
            </div>
            ...
            <div className="space-y-2">
                <Button
                    block
                    disabled={
                        !aiAvailable || isAnalyzing || agenda.length === 0
                    }
                    loading={isAnalyzing}
                    onClick={onAnalyze}
                    icon={
                        !isAnalyzing ? <Bot className="h-3 w-3" /> : undefined
                    }
