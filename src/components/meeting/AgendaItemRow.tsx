        ...
        <div
            ...
            className={cn(
                ...
                isCompleted && !isCurrent
                    ? "border-emerald-100 bg-emerald-50/50 grayscale-[0.2]"
                    : "",
                isCurrent
                    ? "z-10 scale-[1.01] border-primary shadow-lg ring-2 ring-primary/20"
                    : ""
            )}
            style={{
        ...
        >
            <div className="flex items-start gap-3 text-left sm:gap-4">
                <div className="min-w-0 flex-1">
                    <div className="mb-1 flex items-start justify-between gap-3">
                        ...
                        <div
                            ...
                            onClick={() =>
                                isCurrent &&
                                setTimerMode(
                                    timerMode === "left" ? "used" : "left"
                                )
                            }
                            className={cn(
                                "flex shrink-0 items-center gap-1.5 rounded-full px-2 py-1 transition-all",
                                isCurrent
                    ...
                    <p className="line-clamp-3 text-xs md:text-sm text-slate-500">
