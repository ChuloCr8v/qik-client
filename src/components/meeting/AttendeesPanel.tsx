      ...
      <div className="-mt-4 custom-scrollbar max-h-[300px] space-y-1.5 overflow-y-auto pr-1">
        {participants.length > 0 ? (
          participants.map(participant => {
            ...
            return (
              <div key={participant.id} className="lg:bg-slate-50 group flex items-center gap-2 rounded-xl border border-border  p-1.5 transition-all hover:border-primary/20 hover: ">
