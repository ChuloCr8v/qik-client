...
export default function InviteModal({ isOpen, onClose, meetingTitle, invitees, onAddInvitee }: InviteModalProps) {
      ...
      <div className="space-y-6">
        {invitees.length > 0 && (
          <div className="rounded-2xl border border-border bg-slate-50 p-3">
            <p className="mb-2 text-[10px] font-semibold uppercase tracking-widest text-muted">Current invitees</p>
