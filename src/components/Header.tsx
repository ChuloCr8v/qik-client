        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          {user ? (
                  ...
                  <>
                    ...
                    <div className="absolute right-0 mt-2 z-50 w-80 overflow-hidden rounded-2xl border border-border bg-white shadow-xl ring-1 ring-black/5">
                      <div className="border-b border-border bg-slate-50/50 px-4 py-3 flex items-center justify-between">
                        <h3 className="text-xs font-semibold uppercase  text-muted">Notifications</h3>
                        {unreadCount > 0 && (
                      ...
                      <div className="max-h-96 overflow-y-auto">
                        {notifications.length > 0 ? (
                          ...
                          <div className="py-12 text-center">
                            ...
                            <p className="mt-2 text-xs text-muted uppercase ">
            ...
            <button
              ...
              className="rounded-xl h-full! bg-primary px-4 py-2 text-sm font-semibold text-white   hover:opacity-90 active:scale-95 transition-all"
            >
              Get Started
            </button>
          )}
