...
export function EmailSignInForm({
  ...
  return (
    ...
    <button
      disabled={isLoading}
      className="flex h-10! w-full items-center justify-center gap-2 rounded-xl bg-secondary px-6 py-3 text-white shadow-lg shadow-slate-200 transition-all hover:bg-slate-800 active:scale-[0.98] disabled:opacity-50"
      >
